use reqwest::Client;
use shr_crypto::PinHash;
use shr_protocol::{CreateLiveShareRequest, CreateLiveShareResponse, ShareKind};
use shr_transfer::{InputKind, ShareInput};

use crate::error::HostedError;

const DEFAULT_API: &str = "https://shr.rip";
...
pub fn api_base_from_env() -> ApiConfig {
    let base = std::env::var("SHR_API_URL").unwrap_or_else(|_| DEFAULT_API.to_string());
    ApiConfig::new(base)
}
