/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 15baaaaf96bd20d838a960ad0b5d9346)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 
interface __BaseEnv_Env {
	STORED: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	LIVE_SHARE: DurableObjectNamespace<import("./src/index").LiveShareDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LiveShareDO";
	}
